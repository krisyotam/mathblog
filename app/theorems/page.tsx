    ...
    <main className="min-h-screen px-4 py-8 bg-background text-foreground">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-sm text-muted-foreground mb-8">
          The theorems presented on this page are original discoveries made through my own exploration of mathematics.
          While some may have been previously established, they are included here as a practice in developing
          mathematical thinking and proof construction.
        </p>
